...
var checkNumInputs = function checkNumInputs(selector) {
  var inputForms = document.querySelectorAll(selector);
  inputForms.forEach(function (number) {
...
var images = function images() {
  ...
  var workClass = document.querySelector(".works");
  ...
  workClass.addEventListener("click", function (e) {
    e.preventDefault();

    if (e.target && e.target.classList.contains("preview")) {
      imgPopup.style.display = "flex";
      document.body.style.overflow = "hidden";
      var srcImage = e.target.parentNode.getAttribute('href');
...
var tabs = function tabs(headerSelector, tabsSelector, contentSelector, activeClass) {
  ...
  header.addEventListener("click", function (event) {
    if (event.target && (event.target.classList.contains(tabsSelector) || event.target.parentNode.classList.contains(tabsSelector))) {
